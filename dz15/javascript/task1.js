...
if (confirm('Почати тестування?')) {
    ...
    if (objList[0].getSum)
        document.write(`Сума чисел 1-го масиву: ${objList[0].getSum()}<br>`);
    if (objList[1].getProd)
        document.write(`Добуток чисел 1-го масиву: ${objList[1].getProd.apply(objList[0])}<br>`);
    if (objList[0].getSum)
        document.write(`Сума чисел 2-го масиву: ${objList[0].getSum.call(objList[1])}<br>`);
    if (objList[1].getProd)
        document.write(`Добуток чисел 2-го масиву: ${objList[1].getProd()}<br>`);
}
