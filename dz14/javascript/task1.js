...
if (confirm('Почати тестування?')) {
    ...
    const sponsorNames = websites.flatMap(site => site.sponsors.map((s) => `${s.sponsorFirstName.trim()} ${s.sponsorLastName.trim()}`));
    ...
    websites.sort((a, b) => { var _a, _b; return ((_a = b.profit) !== null && _a !== void 0 ? _a : 0) - ((_b = a.profit) !== null && _b !== void 0 ? _b : 0); });
